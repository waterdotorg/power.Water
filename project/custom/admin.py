...
from custom.models import Profile, Post, TwitterStatusUpdate, \
    FacebookStatusUpdate, FacebookStatusUpdateLog, FacebookOGReferredLog, \
    FriendJoinedEmailLog, TwitterAutoFriendshipLog, TwitterStatusUpdateLog


class ProfileAdmin(admin.ModelAdmin):
    list_display = ['user', 'followers', 'user_referrer', 'source_referrer',
                    'social_data_completed']
...
class TwitterStatusUpdateLogAdmin(admin.ModelAdmin):
    ...
    search_fields = ['user__username', 'user__first_name', 'user__last_name',
                     'twitter_status_update__content']
    ordering = ['-created_date']
...
class FacebookStatusUpdateAdmin(admin.ModelAdmin):
    list_display = ['name', 'link', 'caption', 'start_date', 'end_date',
                    'created_date']
...
class FacebookOGReferredLogAdmin(admin.ModelAdmin):
    ...
    search_fields = ['user__username', 'user__first_name', 'user__last_name',
                     'user_referred__username', 'user_referred__first_name',
                     'user_referred__last_name']
    ordering = ['-created_date']
