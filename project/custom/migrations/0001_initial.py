...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('custom_profile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('followers', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=256, blank=True)),
            ('user_referrer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_referrer', null=True, to=orm['auth.User'])),
            ('source_referrer', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('type', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('semaphore_twitter', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('semaphore_facebook', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('social_data_completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('custom', ['Profile'])


    def backwards(self, orm):
        # Deleting model 'Profile'
        db.delete_table('custom_profile')
