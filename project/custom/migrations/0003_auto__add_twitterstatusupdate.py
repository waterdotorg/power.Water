...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TwitterStatusUpdate'
        db.create_table('custom_twitterstatusupdate', (
        ...
        db.send_create_signal('custom', ['TwitterStatusUpdate'])

        # Adding M2M table for field groups on 'TwitterStatusUpdate'
        db.create_table('custom_twitterstatusupdate_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('twitterstatusupdate', models.ForeignKey(orm['custom.twitterstatusupdate'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('custom_twitterstatusupdate_groups', ['twitterstatusupdate_id', 'group_id'])


    def backwards(self, orm):
        # Deleting model 'TwitterStatusUpdate'
        db.delete_table('custom_twitterstatusupdate')

        # Removing M2M table for field groups on 'TwitterStatusUpdate'
        db.delete_table('custom_twitterstatusupdate_groups')
