...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacebookStatusUpdateLog'
        db.create_table('custom_facebookstatusupdatelog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('facebook_status_update', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['custom.FacebookStatusUpdate'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('custom', ['FacebookStatusUpdateLog'])

        # Adding unique constraint on 'FacebookStatusUpdateLog', fields ['facebook_status_update', 'user']
        db.create_unique('custom_facebookstatusupdatelog', ['facebook_status_update_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FacebookStatusUpdateLog', fields ['facebook_status_update', 'user']
        db.delete_unique('custom_facebookstatusupdatelog', ['facebook_status_update_id', 'user_id'])

        # Deleting model 'FacebookStatusUpdateLog'
        db.delete_table('custom_facebookstatusupdatelog')
