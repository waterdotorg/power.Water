...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TwitterAutoFriendshipLog'
        db.create_table('custom_twitterautofriendshiplog', (
        ...
        db.send_create_signal('custom', ['TwitterAutoFriendshipLog'])


    def backwards(self, orm):
        # Deleting model 'TwitterAutoFriendshipLog'
        db.delete_table('custom_twitterautofriendshiplog')
