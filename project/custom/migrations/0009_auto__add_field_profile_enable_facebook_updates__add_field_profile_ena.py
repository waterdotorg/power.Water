...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.enable_facebook_updates'
        db.add_column('custom_profile', 'enable_facebook_updates',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Profile.enable_twitter_updates'
        db.add_column('custom_profile', 'enable_twitter_updates',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Profile.enable_email_updates'
        db.add_column('custom_profile', 'enable_email_updates',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.enable_facebook_updates'
        db.delete_column('custom_profile', 'enable_facebook_updates')

        # Deleting field 'Profile.enable_twitter_updates'
        db.delete_column('custom_profile', 'enable_twitter_updates')

        # Deleting field 'Profile.enable_email_updates'
        db.delete_column('custom_profile', 'enable_email_updates')
