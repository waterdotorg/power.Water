...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacebookOGReferredLog'
        db.create_table('custom_facebookogreferredlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user', to=orm['auth.User'])),
            ('user_referred', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_referred', to=orm['auth.User'])),
        ...
        db.send_create_signal('custom', ['FacebookOGReferredLog'])


    def backwards(self, orm):
        # Deleting model 'FacebookOGReferredLog'
        db.delete_table('custom_facebookogreferredlog')
    ...
    models = {
        ...
        'custom.facebookogreferredlog': {
            'Meta': {'object_name': 'FacebookOGReferredLog'},
