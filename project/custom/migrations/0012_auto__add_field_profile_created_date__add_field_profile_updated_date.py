...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.created_date'
        db.add_column('custom_profile', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Profile.updated_date'
        db.add_column('custom_profile', 'updated_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 12, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.created_date'
        db.delete_column('custom_profile', 'created_date')

        # Deleting field 'Profile.updated_date'
        db.delete_column('custom_profile', 'updated_date')
