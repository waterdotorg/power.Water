...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.image_mobile'
        db.add_column('custom_post', 'image_mobile',
                      self.gf('django.db.models.fields.files.ImageField')(default='null.jpg', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.image_mobile'
        db.delete_column('custom_post', 'image_mobile')
