...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TwitterStatusUpdate.picture'
        db.add_column('custom_twitterstatusupdate', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TwitterStatusUpdate.picture'
        db.delete_column('custom_twitterstatusupdate', 'picture')
