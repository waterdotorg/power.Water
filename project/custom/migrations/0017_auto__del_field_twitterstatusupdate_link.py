...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TwitterStatusUpdate.link'
        db.delete_column('custom_twitterstatusupdate', 'link')


    def backwards(self, orm):
        # Adding field 'TwitterStatusUpdate.link'
        db.add_column('custom_twitterstatusupdate', 'link',
